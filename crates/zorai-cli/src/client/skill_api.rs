...
) -> Result<(Vec<zorai_protocol::SkillVariantPublic>, Option<String>)> {
...
pub async fn send_skill_inspect(
    identifier: &str,
) -> Result<(Option<zorai_protocol::SkillVariantPublic>, Option<String>)> {
...
pub async fn send_skill_search(query: &str) -> Result<Vec<zorai_protocol::CommunitySkillEntry>> {
