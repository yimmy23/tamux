...
- Security in zorai is governance over transitions and blast radius, not raw command keyword matching alone.
...
pub(super) const WELES_INTERNAL_BYPASS_MARKER_PREFIX: &str = "zorai:weles:internal-bypass:";
