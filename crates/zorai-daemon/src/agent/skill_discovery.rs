...
pub(crate) fn build_skill_drafting_prompt(
    ...
    format!(
        "You are a skill documentation agent for an AI assistant.\n\n\
         ...
         Optional zorai-specific tags must go under `zorai.context_tags`, not top-level `context_tags`.\n\n\
...
impl AgentEngine {
    ...
    /// Creates `~/.zorai/skills/drafts/{skill_name}/SKILL.md` and registers in DB.
