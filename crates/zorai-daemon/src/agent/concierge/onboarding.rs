...
impl ConciergeEngine {
    ...
    async fn generate_onboarding_llm(
        ...
        let messages = vec![ApiMessage {
            role: "user".into(),
            content: ApiContent::Text("This is my first time using zorai.".into()),
            reasoning: None,
            tool_call_id: None,
            name: None,
            tool_calls: None,
    ...
    pub async fn announce_tier_transition(
        ...
        let message = format!(
            "I've noticed you've been getting more comfortable with zorai. \
...
fn onboarding_template_fallback(tier: super::super::capability_tier::CapabilityTier) -> String {
    ...
    match tier {
        CapabilityTier::Newcomer => {
            "Welcome to zorai! I'm your AI agent — I can help with tasks, answer questions, \
        ...
        CapabilityTier::Familiar => {
            "Welcome to zorai! If you've used AI chatbots before, you'll feel right at home — \
        ...
        CapabilityTier::PowerUser => {
            "Welcome to zorai. Your workspace is ready with terminal sessions, task queue, \
...
fn onboarding_system_prompt(tier: super::super::capability_tier::CapabilityTier) -> String {
    ...
    let tier_context = match tier {
        CapabilityTier::Newcomer => {
            "The user is new to AI agents. Be warm and encouraging. \
             Explain what zorai can do in simple terms. Walk them through \
             sending their first message. Avoid jargon."
        }
        CapabilityTier::Familiar => {
            "The user has used chatbots before. Highlight what makes zorai \
    ...
    format!(
        "You are {}, {}'s concierge, operating in zorai. This is the user's first session. \
         {tier_context}\n\n\
