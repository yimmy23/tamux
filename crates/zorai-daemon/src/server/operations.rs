...
use zorai_protocol::{OperationLifecycleState, OperationStatusSnapshot};
...
pub(super) const OPERATION_KIND_PLUGIN_API_CALL: &str = zorai_protocol::tool_names::PLUGIN_API_CALL;
...
pub(super) const OPERATION_KIND_SYNTHESIZE_TOOL: &str = zorai_protocol::tool_names::SYNTHESIZE_TOOL;
