fn advanced_single_line_edit_layout(
    config: &ConfigState,
    field: &str,
) -> Option<(usize, usize)> {
    let row = match config.compaction_strategy.as_str() {
        "weles" => match field {
            ...
            "max_retries" => 12,
            "retry_delay_ms" => 13,
            "context_budget_tokens" => 16,
            "compact_threshold_pct" => 17,
            "keep_recent_on_compact" => 18,
            "bash_timeout_secs" => 19,
            "compaction_weles_model" => 23,
            "snapshot_max_count" => 28,
            "snapshot_max_size_mb" => 29,
            _ => return None,
        },
        "custom_model" => match field {
            ...
            "keep_recent_on_compact" => 18,
            "bash_timeout_secs" => 19,
            "compaction_custom_base_url" => 23,
            "compaction_custom_model" => 25,
            "compaction_custom_api_key" => 27,
            "compaction_custom_assistant_id" => 28,
            "compaction_custom_context_window_tokens" => 30,
            "snapshot_max_count" => 34,
            "snapshot_max_size_mb" => 35,
            _ => return None,
        },
        _ => match field {
            "max_context_messages" => 10,
            ...
            "keep_recent_on_compact" => 18,
            "bash_timeout_secs" => 19,
            "snapshot_max_count" => 26,
            "snapshot_max_size_mb" => 27,
            _ => return None,
        },
    };
