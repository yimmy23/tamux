fn advanced_single_line_edit_layout(config: &ConfigState, field: &str) -> Option<(usize, usize)> {
    let row = match config.compaction_strategy.as_str() {
        "weles" => match field {
            ...
            "compact_threshold_pct" => 19,
            "keep_recent_on_compact" => 20,
            "bash_timeout_secs" => 21,
            "compaction_weles_model" => 25,
        ...
        "custom_model" => match field {
            ...
            "keep_recent_on_compact" => 20,
            "bash_timeout_secs" => 21,
            "compaction_custom_base_url" => 25,
            "compaction_custom_model" => 27,
            "compaction_custom_api_key" => 29,
            "compaction_custom_assistant_id" => 30,
            "compaction_custom_context_window_tokens" => 32,
            "snapshot_max_count" => 36,
            "snapshot_max_size_mb" => 37,
            _ => return None,
        },
        _ => match field {
            "max_context_messages" => 10,
