...
pub enum ClientMessage {
    ...
    ListAgentThreads,
    GetAgentThread { thread_id: String, #[serde(default, alias = "trashed")] include_deleted: bool },
    ...
    AgentExternalRuntimeMigrationPreview { runtime: String, #[serde(default)] config_path: Option<String> },
    AgentExternalRuntimeMigrationApply { runtime: String, #[serde(default)] config_path: Option<String>, #[serde(default)] conflict_policy: String },
    AgentExternalRuntimeMigrationReport { #[serde(default)] runtime: Option<String>, #[serde(default)] limit: Option<usize> },
    AgentExternalRuntimeMigrationShadowRun { runtime: String },
