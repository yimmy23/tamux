...
pub enum ClientMessage {
    ...
    AgentStartDivergentSession { problem_statement: String, thread_id: String, #[serde(default, skip_serializing_if = "Option::is_none")] goal_run_id: Option<String>, #[serde(default, skip_serializing_if = "Option::is_none")] custom_framings_json: Option<String> },
