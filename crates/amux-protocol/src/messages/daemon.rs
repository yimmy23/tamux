...
pub enum DaemonMessage {
    ...
    AgentGeneratedToolResult { #[serde(default)] tool_name: Option<String>, result_json: String },
    AgentProviderValidation { provider_id: String, valid: bool, #[serde(default)] error: Option<String>, #[serde(default)] models_json: Option<String> },
    ...
    AgentExplanation { explanation_json: String },
    AgentDivergentSessionStarted { session_json: String },
