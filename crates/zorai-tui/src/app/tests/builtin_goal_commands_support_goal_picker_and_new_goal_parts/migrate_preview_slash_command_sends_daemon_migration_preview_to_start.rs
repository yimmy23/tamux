...
fn resize_clears_drag_snapshots() {
    ...
    model.work_context_drag_anchor_point = Some(widgets::chat::SelectionPoint { row: 0, col: 0 });
    model.work_context_drag_current_point = Some(widgets::chat::SelectionPoint { row: 0, col: 1 });
