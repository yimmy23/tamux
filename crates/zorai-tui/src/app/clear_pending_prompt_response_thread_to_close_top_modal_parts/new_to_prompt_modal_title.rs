...
impl TuiModel {
    pub fn new(
        ...
        Self {
            ...
            voice_recorder: None,
            voice_player: None,
            voice_player_ipc: None,
            voice_paused: false,
            voice_player_seq: 0,
            tts_audio_cache: std::collections::HashMap::new(),
            pending_tts_cache_key: None,
            ...
            pending_participant_instruction_edit: None,
            participant_actions_target: None,
