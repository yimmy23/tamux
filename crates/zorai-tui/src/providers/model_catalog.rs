...
pub(super) fn known_models_for_provider_auth(
    ...
    let models: &[(&str, &str, u32)] = match provider {
        ...
        PROVIDER_ID_ANTHROPIC => &[
            ...
            ("claude-opus-4-1-20250805", "Claude Opus 4.1", 200_000),
            ...
            ("claude-3-7-sonnet-20250219", "Claude Sonnet 3.7", 200_000),
            ("claude-haiku-4-5-20251001", "Claude Haiku 4.5", 200_000),
            ("claude-3-5-haiku-20241022", "Claude Haiku 3.5", 200_000),
            ("claude-3-opus-20240229", "Claude Opus 3", 200_000),
        ...
        PROVIDER_ID_POOLSIDE => &[("poolside/laguna-m.1", "Poolside Laguna M.1", 256_000)],
        PROVIDER_ID_QWEN => &[
        ...
        PROVIDER_ID_ALIBABA_TOKEN_PLAN => &[
            ("qwen3.8-max-preview", "Qwen3.8 Max Preview", 1_000_000),
        ...
        PROVIDER_ID_XIAOMI_MIMO | PROVIDER_ID_XIAOMI_MIMO_TOKEN_PLAN => &[
            ...
            ("mimo-v2.5-asr", "MiMo V2.5 ASR", 128_000),
            (
            ...
            ("mimo-v2-tts", "MiMo V2 TTS", 128_000),
        ],
